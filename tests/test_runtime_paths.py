...
def test_supabase_config_selection_uses_explicit_then_config_then_fallback(
    tmp_path,
):
    import state

    explicit = tmp_path / "explicit" / ".supabase_v9_config.json"
    ...
    environ = {
        "DEFENSE_TRACKER_SUPABASE_CONFIG": str(explicit),
